import { c as createLucideIcon, o, r as reactExports, v as vt, p as useBetHistory, j as jsxRuntimeExports, q as BookOpen, b as cn, S as Skeleton, s as BetStatus, t as BetType, w as useBetHistoryStats, T as TrendingUp, A as Activity, x as useUpdateBetOutcome } from "./index-C0SLgS7f.js";
import { B as Badge } from "./badge-BD8-c252.js";
import { m as motion } from "./proxy-Bc22TOLI.js";
import { T as TrendingDown } from "./trending-down-D6ER7YwI.js";
...
function ConfidenceMeter({ score }) {
  ...
  const color = n >= 70 ? "bg-primary" : n >= 45 ? "bg-accent" : "bg-destructive/60";
  const label = n >= 70 ? "High" : n >= 45 ? "Medium" : "Low";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-mono uppercase tracking-widest text-muted-foreground", children: "Confidence" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-mono font-semibold text-foreground", children: [
        n,
        "% ",
        label
      ] })
...
function StatsBar() {
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-5 gap-3 mb-7", children: [1, 2, 3, 4, 5].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-20 rounded-xl" }, i)) });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: statItems.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: cn("w-3 h-3", item.color) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-mono uppercase tracking-widest text-muted-foreground", children: item.label })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: cn("font-display text-2xl font-bold", item.color), children: item.value })
          ]
        },
        item.label
      ))
...
function OutcomeUpdater({ bet }) {
  ...
  const handleSubmit = () => {
    updateOutcome.mutate(
      ...
      {
        onSuccess: () => {
          ue.success("Bet outcome updated", {
            description: `Marked as ${getStatusLabel(selectedStatus)}`
          });
          setOpen(false);
          setResult("");
        },
        onError: (err) => ue.error("Failed to update", { description: err.message })
      }
    );
  };
  if (bet.status !== BetStatus.pending) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 pt-3 border-t border-border/25", children: [
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap", children: [BetStatus.won, BetStatus.lost, BetStatus.push].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              className: cn(
                ...
                selectedStatus === s ? getStatusColor(s) : "border-border/40 text-muted-foreground hover:border-border/60"
              ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: updateOutcome.isPending ? "Saving…" : "Save Outcome"
            }
          )
        ]
      }
...
function BetCard({ bet, index }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        (isWon || isLost) && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: cn(
              "h-[2px]",
              isWon ? "bg-gradient-to-r from-transparent via-primary to-transparent" : "bg-gradient-to-r from-transparent via-destructive/60 to-transparent"
            )
          }
        ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  ...
                  children: getStatusLabel(bet.status)
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  ...
                  children: getBetTypeLabel(bet.betType)
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono text-muted-foreground/70 shrink-0", children: formatDate(bet.recommendedAt) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] font-mono text-muted-foreground mb-1", children: [
              bet.awayTeam,
              " @ ",
              bet.homeTeam
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-base font-bold text-foreground tracking-tight", children: bet.description })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ConfidenceMeter, { score: bet.confidence }),
            bet.preGameOdds && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-mono uppercase tracking-widest text-muted-foreground", children: "Pre-game odds" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-mono font-semibold text-foreground", children: bet.preGameOdds })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            ...
            expanded && /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.p,
              {
                ...
                children: bet.reasoning
              }
            )
          ] }),
          bet.gameResult && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 pt-3 border-t border-border/25", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-mono uppercase tracking-widest text-muted-foreground mb-0.5", children: "Result" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body text-foreground", children: bet.gameResult })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(OutcomeUpdater, { bet })
        ] })
      ]
    }
  );
...
function HistoryPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-screen-xl mx-auto px-4 py-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-mono uppercase tracking-[0.25em] text-primary font-semibold", children: "CourtEdge" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-foreground tracking-tight", children: "Bet History" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body text-muted-foreground mt-0.5", children: "All past recommendations with outcomes and performance tracking" })
        ]
      }
    ),
        ...
        children: FILTERS.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: cn(
              ...
              activeFilter === f.key ? "border-primary/50 text-primary bg-primary/8" : "border-border/40 text-muted-foreground hover:border-border/60 hover:text-foreground"
            ),
            children: [
              f.label,
              f.key !== "all" && filtered.length > 0 && activeFilter === f.key && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1.5 text-[9px] opacity-70", children: filtered.length })
            ]
          },
          f.key
        ))
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-5 h-px bg-gradient-to-r from-primary/30 via-border/40 to-transparent" }),
    isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3", children: [1, 2, 3, 4, 5, 6].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-44 rounded-xl" }, i)) }),
    !isLoading && filtered.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-muted/40 border border-border/40 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "w-7 h-7 text-muted-foreground/60" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg font-semibold text-foreground", children: activeFilter === "all" ? "No bet recommendations yet" : `No ${activeFilter} bets` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body text-muted-foreground", children: activeFilter === "all" ? "Investigate a game to generate recommendations" : `No bets match the ${activeFilter} filter` })
          ] })
        ]
      }
    ),
    !isLoading && filtered.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-4 sm:grid-cols-2 lg:grid-cols-3", children: filtered.map((bet, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(BetCard, { bet, index: i }, bet.id)) })
  ] });
}
export {
